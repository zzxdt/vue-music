            ...
            <div class="simi-mv">
                ...
                <div class="aside-main mv-main">
                    <div class="item" :key="'' + item.id + index" v-for="(item, index) in simiMv">
                        ...
                        <div class="info">
                            <router-link :to="{ path: '/mvlist/mv', query: { id: item.id } }" class="mv-name">{{ item.name
                            }}</router-link>
                            ...
                            <div class="mv-playCount"><i class="iconfont icon-mvlist"></i>
                                {{ $utils.formartNum(item.playCount) }}</div>
...
import videoPlay from '../../../node_modules/vue3-video-play/dist/index.mjs'
